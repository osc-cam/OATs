...
%%Transaction codes
\newcommand{\OA}{EBDU}
\newcommand{\membership}{EBDV}
\newcommand{\pagecolour}{EBDW (Page/colour)}
...
\path [xshift=\xshift cm, yshift=\yshift cm] (2.5 , 2.8) node[blue, inner sep=0pt, anchor=base]{\large{\textbf{\invrefzd}}};
\path [xshift=\xshift cm, yshift=\yshift cm] (2.5 , 2.3) node[blue, inner sep=0pt, anchor=base]{\scriptsize{Invoice no:\textbf{\invoiceno}}};
\path [xshift=\xshift cm, yshift=\yshift cm] (5.1 , 4.9) node[red, inner sep=0pt, anchor=north west]{Processed by\footnotesize{\currentagent}};
...
\path [xshift=\xshift cm, yshift=\yshift cm] (6 , 3) node[rectangle, blue, inner sep=0pt, anchor=north west, fill=white, fill opacity=1]{\critical};
}
